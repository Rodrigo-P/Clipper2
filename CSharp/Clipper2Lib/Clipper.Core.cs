...
{
  [Serializable, DebuggerTypeProxy(typeof(Proxy64)), DebuggerDisplay("isPoly = {isPoly}")]
  public class Path64 : List<Point64>
  {
    public bool isPoly;
    public Path64(int size, bool isPoly) : base(size)
    {
      this.isPoly = isPoly;
    }
    public Path64() : base() {
    ...
    {
      private ICollection<Point64> collection;

      public Proxy64(ICollection<Point64> collection)
      {
        if (collection == null)
      ...
      public Point64[] Items
      {
        get
        {
          Point64[] array = new Point64[this.collection.Count];
  ...
  {
    public Paths64(int size) : base(size) { }
    public Paths64() : base() { }
    public Paths64(Paths64 list)
    {
      foreach (Path64 p in list)
      {
        Add(p);
      }
    }
  ...
  [Serializable, DebuggerTypeProxy(typeof(ProxyD)), DebuggerDisplay("isPoly = {isPoly}")]
  public class PathD : List<PointD>
  {
    public bool isPoly;
    public PathD(int size, bool isPoly) : base(size)
    {
      this.isPoly = isPoly;
    }
    public PathD() : base() {
    ...
    public class ProxyD
    {
      private ICollection<PointD> collection;

      public ProxyD(ICollection<PointD> collection)
      {
        if (collection == null)
          throw new ArgumentNullException("collection");
        this.collection = collection;
      ...
      public PointD[] Items
      {
        get
        {
          PointD[] array = new PointD[this.collection.Count];
          this.collection.CopyTo(array, 0);
          return array;
        }
      }
  ...
  {
    public PathsD(int size) : base(size) { }
    public PathsD() : base() { }
    public PathsD(PathsD list)
    {
      foreach (PathD p in list)
      {
        Add(p);
      }
    }
